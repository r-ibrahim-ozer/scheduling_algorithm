...
class Machines():
    ...
    def dict_est_time(self,solution_dict_0, solution_dict_1):
        self.washing_time_1 = 0
        self.washing_time_2 = 0
        ...
        self.df_0.keys = list(solution_dict_0)

        """
         makine_no  Sipariş no sap no   Renk  Kazan  
         miktar(kg) sap bitiş zamanı       kamyon zamani  satış istek zamanı        
         kamyon/satis
         """
        ...
        self.calculate_delta(self.df_0.keys[0],0,self.df_0.pack_end_time)
        ...
        self.calculate_delta(self.df_1.keys[0],1, self.df_1.pack_end_time)
        ...
        for i in range(1,self.df_0.df_len):
            ...
            self.calculate_delta(self.df_0.keys[i],0, self.df_0.pack_end_time)
            ...
            if i < self.df_1.df_len:
                ...
                self.update_avaliable_pot_time(self.df_1.pack_end_time, pot_number)
                self.calculate_delta(self.df_1.keys[i],1, self.df_1.pack_end_time)
                self.start_time
